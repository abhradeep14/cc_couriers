...
<html>
    ...
    <body style="font-family: Arial, Helvetica, sans-serif;">
        <div ><img src="Image/logo.png" id="logo" style="height: 200px !important;  margin-top: 10px !important;"  ></div>
        ...
        <nav class="navbar navbar-toggleable-md navbar-expand-lg navbar-default navbar-light mb-10" style="background-color: rgba(255, 255, 255, 0.7); margin-bottom: 20px; margin-top:10px !important;">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="mainNav">
                    <div class="navbar-nav  " style="margin: 0 auto; font-size: larger;">
            ...
            <div id = "carouselwithIndicators" class = "carousel slide container-fluid mt-10" data-ride = "carousel" style="width: 85%; height: 100%; border-radius: 15px;">
               ...
               <div class =" carousel-inner">
                  <div class = "carousel-item active">
                     <img class = "d-block " 
                        src = "Images/c2.jpg" 
                        alt = "First slide" style="height: 80vh; width: 100;">
                  </div>
                  
                  <div class = "carousel-item">
                     <img class = "d-block " 
                        src = "Images/c3.jpg" 
                        alt = "Second slide" style="height: 80vh; width: 100;">
                  </div>
                  <div class = "carousel-item">
                     <img class = "d-block " 
                        src = "Images/c4.jpg" 
                        alt = "Third slide" style="height: 80vh; width: 100;">
                  </div>
               </div>
         ...
         <div class="container" id="about" style="margin-top: 20px; width: 85%;">
             <div class="row">
                <div class="col-md-6 p-5" style="background-color: rgba(255, 255, 255, 0.7); color: black; border-radius: 15px; ">
                    ...
                    <p class="pb-3" style="border-bottom: 2px solid white;"> The Project Was Created As A Part of Our DBMS Project For The Year 2024.</p>
                    <p class="pb-4" style="border-bottom: 4px solid white;" >Aryan Mondal(82)  Abhradeep Basak(84)  Preet Parekh(103)</p>
                </div>
                <div class="col-md-6">
            ...
            <div class="row">
                <div class="col-md-6 text-center p-5" style="background-color: rgba(255, 255, 255, 0.7); color: black; ">
                    ...
                    <?php foreach($empmonth as $emp) : ?>
                        <div style="margin:auto !important; border-bottom:1px solid white;">
